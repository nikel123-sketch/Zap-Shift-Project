...
const Login = () => {
  ...
  // googlehendlelogin
  const googlehendlelogin=()=>{
    console.log("googlehendlelogin");
    singInWithGoogle()
    .then(result=>{
        setUser(result.user);
        setLoading(false);
    ...
    <div>
      <div className="card bg-base-100 w-full mx-auto max-w-sm shrink-0 shadow-2xl">
        <div className="card-body">
          <form onSubmit={handleSubmit(hendleloginform)}>
